...
|Main columns | Description|
  |-|-|
  `freelancer_ID` | Identification of a freelancer  
  `name` | name  
...
|------|-------------|---------|---------|-------|
| Global_Freelancers_Dataset.csv | Original messy data | 1000 | 12 | Contains duplicates and missing values, requires deep cleanning |
